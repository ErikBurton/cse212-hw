public class SimpleQueue {
    public static void Run() {
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue insterting at the front of the queue.
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // Should be adding to the end of the queue.
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; // Take first item in queue.
        _queue.RemoveAt(0); // Remove at index 0.
        return value;
    }
}