public static class Trees
{
    ...
    private static void InsertMiddle(int[] sortedNumbers, int first, int last, BinarySearchTree bst)
    {
        ...
        // Base case: If current range is invalid, return (nothing to insert)
        if (first > last)
            return;
        ...
        // Recursively insert the left half of the segment
        InsertMiddle(sortedNumbers, first, mid - 1, bst);

        // Recursively insert the right half of the segment
